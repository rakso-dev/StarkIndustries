...
public class LowerBody extends PiezaRobotica {
    ...
    public LowerBody(int id, String linea, String color, double largo, double ancho, double alto, int r_fabricante, int r_armadura, double altura_suelo) {
        super(id, linea, color, largo, ancho, alto, r_fabricante, r_armadura);
        this.altura_suelo = altura_suelo;
    } //Select y update

    public LowerBody(String linea, String color, double largo, double ancho, double alto, int r_fabricante, int r_armadura, double altura_suelo) {
